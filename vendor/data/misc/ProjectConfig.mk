...
CUSTOM_HAL_COMBO = mt8183
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = ov13855_mipi_raw ov13855main2_mipi_raw
CUSTOM_HAL_LENS = dummy_lens dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = ov13855main2_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = ov13855_mipi_raw ov13855main2_mipi_raw
...
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov13855main2_mipi_raw
...
CUSTOM_KERNEL_TOUCHPANEL = ft5726
...
MTK_CHAMELEON_DISPLAY_SUPPORT = yes
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-4 rel_customer_platform_mt8183 rel_customer_modem rel_customer_product_tb
...
MTK_CAM_VSDOF_SINGLE_CAMERA_SUPPORT = yes
...
MTK_PRODUCT_LINE_PLATFORM = MT8183
...
AMZN_PARTITION_TABLE_XML_CONFIG = device/amazon/$(TARGET_PRODUCT)/partition/partition_$(TARGET_PRODUCT).xml
AMZN_FSTAB = yes
AMZN_UEVENTD = yes
AMZN_LATCHED_LASTPC = yes
USE_BLK1_MMC_PATH = yes
MTK_AUDIO_PCM_MERGE_SUPPORT = yes
AMZN_ENABLE_VPU_AUTH = yes
AMZN_CHAMELEON_ALS_RESTRICT_SUPPORT = yes
MTK_EMMC_RPMB_SUPPORT = yes
AMZN_DRMPROV_RPMB_BACKUP = yes
VIDEO_DECODER_LOWLATENCY=yes
